...
import { formatPrice, getPropertyTypeLabel, getStatusLabel, getPriceDurationLabel } from "@/lib/helpers";
...
export default function AgentPropertiesPage() {
  ...
  const fetchProperties = async (page = 1) => {
    ...
    try {
      ...
      // Agent endpoint returns only their own properties since we don't filter by status=AVAILABLE for agent
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <Button variant="ghost" size="sm" asChild title="Edit">
                            <Link href={`/dashboard/agent/properties/edit?id=${property.id}`}>
